...
//    Driver.selectByIndex(dropdown element, "91303")
    ...
    public static void isDisplayed(WebElement locate,String message){
        SoftAssert softAssert = new SoftAssert();
        try {
            softAssert.assertTrue(locate.isDisplayed(),message);
    ...
    public static void isSelected(WebElement locate,String message){
        SoftAssert softAssert = new SoftAssert();
        try {
            softAssert.assertTrue(locate.isSelected(),message);
            softAssert.assertAll();
        } catch (AssertionError e) {
            System.out.println(message);
        }
    ...
    // iki degeri icerip icermedigini test eder
    public static void verifyAssertTrue(String expected, String actual, String message) {
        SoftAssert softAssert = new SoftAssert();
        try {
    ...
    public static void isEnabled(WebElement locate,String message){
        SoftAssert softAssert = new SoftAssert();
        try {
            softAssert.assertTrue(locate.isEnabled(),message);
            softAssert.assertAll();
        } catch (AssertionError e) {
            System.out.println(message);
        }
    ...
    // istenen xpath girilerek Liste atarak sonucları yazıdırır
    public static void printListText(WebDriver driver,String xpath) {

        List<WebElement> istenenListe = driver.findElements(By.xpath(xpath));

        int sayac = 1;
        for (WebElement each : istenenListe) {
